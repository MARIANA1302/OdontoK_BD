...
class UserView
{
    ...
    function showFormUser($arrayTypeDocument, $arrayRol, $arrayState)
    {
?>
        <div>
            <form id="insert_user">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <select class="form-control" id="state" name="state" aria-label="Default select example">
                            ...
                            ?>
                                <option value="<?php echo $cod_state ?>"><?php echo $name_state ?></option>
                            <?php
                            }
                            ?>
                        </select>
    ...
    function paginateUsers($array_user, $array_states)
    {
    ?>
            ...
            <div class="card-header row">
                ...
                <div class="col">
                    <form id="search_user" class="row justify-content-around">
                        ...
                        <input class="col-4 form-control" type="text" name="document_number" id="document_number" placeholder="Numero de documento">
                    ...
                    <table class="table table-striped ">
                        ...
                        <tbody>
                            <?php foreach ($array_user as $user) {
                                ...
                                $name = $user->username . " " . $user->user_last_name;
                                $name_state = $user->name_state;
    ...
    function showUser($user, $arrayTypeDocument, $arrayRol, $arrayState)
    {
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="state" name="state" aria-label="Default select example">
                                    <?php
                                    foreach ($arrayState as $state) {
                                        $cod_stateA = $state->cod_state;
                                        $name_stateA = $state->name_state;
                                        if ($cod_stateA == $cod_state) {
                                    ?>
                                            <option selected value="<?php echo $cod_stateA ?>"><?php echo $name_stateA ?></option>
                                        <?php
                                        } else {
                                        ?>
                                            <option value="<?php echo $cod_stateA ?>"><?php echo $name_stateA ?></option>
